      ...
      <Header textColor={"#444B79"} />
        <div className='w-[90%] lg:w-[70%] bg-white p-4 rounded-xl'>
          ...
          <div className='flex gap-2 mt-4'>
            <input value={search[1]} onChange={e=> setSearch([false, e.target.value])} placeholder='Search by Title (alt+k or cmd+k)' className="rounded outline-none border p-1 border-solid" type="text" name="search" />
            <button onClick={()=> setSearch([true, search[1]])} className='rounded h-full bg-[#6C6BAF] p-1 px-2 text-white'>Search</button>
          </div>
          <div className='w-full flex flex-col items-end'>
            <div className=' max-h-[50vh] overflow-scroll mt-6 rounded-lg border border-solid border-[#7D7D7D]'>
            ...
            <div className='mt-4 flex gap-2 items-center'>
              ...
              <svg onClick={previousPage} width="8" height="15" viewBox="0 0 17 30" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <svg onClick={nextPage} className='rotate-180' width="8" height="15" viewBox="0 0 17 30" fill="none" xmlns="http://www.w3.org/2000/svg">
